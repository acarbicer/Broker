...
public class InterestedListAdapter extends ArrayAdapter<Currency> {
	private Context context;
	private ArrayList<Currency> values;
	private LayoutInflater inflater;

	public InterestedListAdapter(Context context, ArrayList<Currency> values) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (rowView == null) {
			...
			rowView = inflater.inflate(R.layout.list_item_my_interesteds, parent, false);
		}
