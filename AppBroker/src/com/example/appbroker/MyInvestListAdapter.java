...
public class MyInvestListAdapter extends ArrayAdapter<Currency> {
	public Context context;
	private ArrayList<Currency> values;
	private LayoutInflater inflater;
	Activity parentActivity;
	public int rowId;
	public MyInvestListAdapter(Context context, ArrayList<Currency> values,Activity parentActivity) {
		super(context, R.layout.list_item_my_invest, values);
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (rowView == null) {
			...
			rowView = inflater.inflate(R.layout.list_item_my_invest, parent,
					false);
		}
		Currency c = values.get(position);

		ImageView logo = (ImageView) rowView.findViewById(R.id.logo_my_invest);
		...
		ImageView arrow = (ImageView) rowView
				.findViewById(R.id.increase__my_invest);
